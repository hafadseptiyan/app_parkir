                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="id_kategori" id="id_kategori">
                                <div class="input-group">
                                    ...
                                    <div class="form-line">
                                        <input type="text" name="kendaraan" value="" id="kendaraan" class="form-control date" placeholder="Jenis Kendaraan">
                                    </div>
                                </div>
                             </form>   
                        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0)" id="edit-kategori" data-id="{{ $row->id_kategori }}">
...
<script>
  $(document).ready(function () {
    ...
    /*  When user click add kategor button */
